...
function velocity_dynamics!(du::Union{Vector{Float64}, T}, dyn_vector::Union{Vector{Float64}, T}, pdmp::PDMP{Version6_2}, evo_tensors::EvoTensors, dyn_type::VelocityODE{Version6_2}) where T<:MVector
    ...
    #Updated (c.f. Lagrangian version for original code in "Lagrangian-type PDMPs//Lagrangian//evo data.jl")
    @view(du[4:end]) .= R0
    for i ∈ axes(R2, 1)
